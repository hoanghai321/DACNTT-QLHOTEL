...
namespace DACNTT.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {   try
            ...
            {
                ModelState.AddModelError("","Đăng nhập thất bại vui lòng đăng nhập lại hoặc liên hệ Admin!!!");
                return View();
            }            
        }
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                 ...
                 case SignInStatus.Success:
                    BigSchool_NhuHoangHaiEntities2 dbb = new BigSchool_NhuHoangHaiEntities2();
                    Session["Email"] = model.Email;
                    if ((string)Session["Email"] != "")
                    {
                        var Role = dbb.AspNetUsers.ToList();
                        int r = 0;
